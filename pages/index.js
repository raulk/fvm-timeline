...
const deadlines = [
  ...
  { milestone: "X testnet launch (former Buildernet, name pending)", date: "2022-12-06", colors: "bg-slate-800 text-slate-100 hover:text-sky-100 hover:bg-sky-600", c: "bg-sky-600/50" },
